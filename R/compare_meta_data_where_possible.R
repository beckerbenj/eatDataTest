...
#'
#'@export
compare_meta_data_where_possible <- function(data1, data2, suffix = NULL) {
  # input validation
  ...
  meta_comparison[c("compared_variables", "differences_variable_level", "differences_value_level")]
}
